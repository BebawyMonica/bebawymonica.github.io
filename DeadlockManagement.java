...
public class DeadlockManagement 
{
	...
	//  Date:         4/27/2016                                                              	
	//  Purpose:   To detect any deadlock in the system and manage it.          
										...
										for(int lastCol = 0; lastCol < input[lastCheck].length; lastCol++)
										{
											if(input[lastCheck][lastCol] == 'w')
												if(lastCheck == 0 && lastCol == 0)
												{
													...
													input[lastCheck][col] = 'n';
													if(input[lastCheck][col] == 'n')
														System.out.println("The deadlock has been resolved!");
													return true;
												}
												else 
												{
